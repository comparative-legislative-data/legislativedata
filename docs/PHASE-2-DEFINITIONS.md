...
Proposed 2026-09-18, and **every item agreed by the owner the same day**, taken one by one in the conversation, and **built the same day as `db/114`**. It settles the item left open in §7
