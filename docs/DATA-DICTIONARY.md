...
| `value_seen` | text |  |  | The value in the source's own words, before any tidying — what was actually printed or said, not what we made of it. Empty where the fact is our coding and no single wording carries it. |
