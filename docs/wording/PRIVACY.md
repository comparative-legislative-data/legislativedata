...
Why it says what it says, who it names and where it sits is `DECISIONS.md`,
2026-09-16, "The privacy page: what it says, who it names, and where it sits".
How it is checked, and **the facts elsewhere on the machine that it states and
that make it untrue if they change**, are `ACCOUNTS-RUNBOOK.md`, "The privacy
page, and its check".

The two lines it adds to other pages, "Privacy" in the top bar and the last line
of the apply page's "What this form keeps", are in `ADMIN-AND-EMAIL.md` and
`APPLY.md`.
